...
- (void)initControlBtn {
    UIView *contentView = [[UIView alloc] initWithFrame:CGRectMake(0, CGRectGetHeight(self.view.frame) - 50, CGRectGetWidth(self.view.frame) , 50)];
    contentView.backgroundColor = [UIColor colorWithRed:.0f green:.0f blue:.0f alpha:0.5];
    ...
    confirmBtn.frame = CGRectMake(CGRectGetWidth(contentView.frame) - 100.0f, 0, 100, 50);
