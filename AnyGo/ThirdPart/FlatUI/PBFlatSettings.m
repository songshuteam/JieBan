...
- (void)navigationBarApperance {
    ...
    NSDictionary *_bartitleTextAttributes = @{UITextAttributeTextColor: [UIColor whiteColor],
                                           UITextAttributeTextShadowColor : [UIColor clearColor],
                                           UITextAttributeFont : [_font fontWithSize:16.0f]};
    
    [[UIBarButtonItem appearance] setTitleTextAttributes:_bartitleTextAttributes forState:(UIControlStateNormal)];
