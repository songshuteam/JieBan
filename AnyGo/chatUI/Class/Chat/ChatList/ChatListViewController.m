...
-(void)refreshDataSource
{
    ...
    dispatch_async(dispatch_get_global_queue(0, 0), ^{
        NSString *userId = [NSString stringWithFormat:@"%lld",[[[NSUserDefaults standardUserDefaults] objectForKey:USERID] longLongValue]];
        ...
        for (EMConversation *conversation in self.dataSource) {
            ...
            NSURL *url = [AGUrlManager urlGetUserInfo:chatter ownId:userId];
